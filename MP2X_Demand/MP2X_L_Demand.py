...
class MP2X_L_Demand(QtWidgets.QWidget):
    ...
    def __init__(self, Panel_ID, nodename, Destination, DualPanelsId, Panels):
        ...
        self.CLIENT13 = customlabel(self, self.nodename, self.Destination, self.id, 13, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT3 = customlabel(self, self.nodename, self.Destination, self.id, 3, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT15 = customlabel(self, self.nodename, self.Destination, self.id, 15, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT14 = customlabel(self, self.nodename, self.Destination, self.id, 14, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT4 = customlabel(self, self.nodename, self.Destination, self.id, 4, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT5 = customlabel(self, self.nodename, self.Destination, self.id, 5, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT10 = customlabel(self, self.nodename, self.Destination, self.id, 10, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT16 = customlabel(self, self.nodename, self.Destination, self.id, 16, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT8 = customlabel(self, self.nodename, self.Destination, self.id, 8, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT7 = customlabel(self, self.nodename, self.Destination, self.id, 7, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT9 = customlabel(self, self.nodename, self.Destination, self.id, 9, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT6 = customlabel(self, self.nodename, self.Destination, self.id, 6, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT11 = customlabel(self, self.nodename, self.Destination, self.id, 11, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT12 = customlabel(self, self.nodename, self.Destination, self.id, 12, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT1 = customlabel(self, self.nodename, self.Destination, self.id, 1, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
        ...
        self.CLIENT2 = customlabel(self, self.nodename, self.Destination, self.id, 2, self.LINE1, self.LINE2, self.Panels, self.DualPanelsId)
...
class customlabel(QLabel):
    ...
    def dragEnterEvent(self, event):
        ...
        self.allowedservices = ["E1", "STM_1_Electrical", "STM_1_Optical", "STM_4", "STM_16", "FE", "1GE"]
